...
include_once "../api/resources/banco.php";
                                ...
                                <!-- Formulário PHP -->
                                    ...
                                    <form action="../api/get.php" method="get">
                                       ...
                                       <p><h1 style="margin-bottom: -3.5rem; font-size:30px; font-weight: 700;">Cursos</h1></p>
                                          ...
                                          <input type="text" id="curso" name="curso" placeholder="   Nome do curso" autocomplete="off"/>                                   
                                          <button id="buttonok" type="button" style="font-weight: 700;">ok</button>
                                       ...
                                       $(function() {
                                          $("#curso").autocomplete({
                                              source: "../api/resources/autocomplete.php"
                                          });
                                      });
                                       ...
                                       <div class="multi-range" data-lbound="7" data-ubound="22" style="bottom: -74px;right: -89px;">
                                            <hr />
                                            <input type="range"
                                                   min="7" max="21" step="1"
                                       ...
                                       <table id="myTable" style="width:100%; color:#344253;">
                                         <tr>
                                           ...
                                           <td id="box1">
                                           <button id="box3" type="button" name="seg" value="7">7</button>
                                           <button id="box3" type="button" name="seg" value="8">8</button>
                                           <button id="box3" type="button" name="seg" value="9">9</button>
                                           <button id="box3" type="button" name="seg" value="10">10</button>
                                           <button id="box3" type="button" name="seg" value="11">11</button>
                                           <button id="box3" type="button" name="seg" value="12">12</button>
                                           <button id="box3" type="button" name="seg" value="13">13</button>
                                           <button id="box3" type="button" name="seg" value="14">14</button>
                                           <button id="box3" type="button" name="seg" value="15">15</button>
                                           <button id="box3" type="button" name="seg" value="16">16</button>
                                           <button id="box3" type="button" name="seg" value="17">17</button>
                                           <button id="box3" type="button" name="seg" value="18">18</button>
                                           <button id="box3" type="button" name="seg" value="19">19</button>
                                           <button id="box3" type="button" name="seg" value="20">20</button>
                                           <button id="box3" type="button" name="seg" value="21">21</button>
                                           <button id="box3" type="button" name="seg" value="22">22</button>
                                           </td>
                                            <button id="buttonx" type="button" onclick="myFunction()" style="left: 1096px;bottom: -30px;font-weight: 700;">X</button>
                                         </tr>
                                         <tr>
                                          <td>
                                          &nbsp;
                                         ...
                                         <tr>
                                           ...
                                           <td id="box1">
                                           <button id="box3" type="button" name="ter" value="7">7</button>
                                           <button id="box3" type="button" name="ter" value="8">8</button>
                                           <button id="box3" type="button" name="ter" value="9">9</button>
                                           <button id="box3" type="button" name="ter" value="10">10</button>
                                           <button id="box3" type="button" name="ter" value="11">11</button>
                                           <button id="box3" type="button" name="ter" value="12">12</button>
                                           <button id="box3" type="button" name="ter" value="13">13</button>
                                           <button id="box3" type="button" name="ter" value="14">14</button>
                                           <button id="box3" type="button" name="ter" value="15">15</button>
                                           <button id="box3" type="button" name="ter" value="16">16</button>
                                           <button id="box3" type="button" name="ter" value="17">17</button>
                                           <button id="box3" type="button" name="ter" value="18">18</button>
                                           <button id="box3" type="button" name="ter" value="19">19</button>
                                           <button id="box3" type="button" name="ter" value="20">20</button>
                                           <button id="box3" type="button" name="ter" value="21">21</button>
                                           <button id="box3" type="button" name="ter" value="22">22</button>
                                           </td>
                                           <button id="buttonx" type="button" onclick="myFunction()" style="left: 1051px;bottom: -87px;font-weight: 700;">X</button>
                                         </tr>
                                         <tr>
                                          <td>
                                          &nbsp;
                                         ...
                                         <tr> <form action="../api/get.php" method="post">
                                       <div style="margin-left: -174px;">
                                       <p><h1 style="margin-bottom: -3.5rem; font-size:30px; font-weight: 700;">Cursos</h1></p>
                                       ...
                                       <table id="myTable" style="width:100%; color:#344253;">
                                         ...
                                         <tr>
                                           ...
                                           <td id="box1">
                                           <button id="box3" type="button" name="qua" value="7">7</button>
                                           <button id="box3" type="button" name="qua" value="8">8</button>
                                           <button id="box3" type="button" name="qua" value="9">9</button>
                                           <button id="box3" type="button" name=
                                           <td style="font-size: 18px; font-weight: 500;">Quarta</td>
                                           <td id="box1">
                                           <button id="box3" type="button" name="qua" value="7">7</button>
                                           <button id="box3" type="button" name="qua" value="8">8</button>
                                           <button id="box3" type="button" name="qua" value="9">9</button>
                                           <button id="box3" type="button" name="qua" value="10">10</button>
                                           <button id="box3" type="button" name="qua" value="11">11</button>
                                           <button id="box3" type="button" name="qua" value="12">12</button>
                                           <button id="box3" type="button" name="qua" value="13">13</button>
                                           <button id="box3" type="button" name="qua" value="14">14</button>
                                           <button id="box3" type="button" name="qua" value="15">15</button>
                                           <button id="box3" type="button" name="qua" value="16">16</button>
                                           <button id="box3" type="button" name="qua" value="17">17</button>
                                           <button id="box3" type="button" name="qua" value="18">18</button>
                                           <button id="box3" type="button" name="qua" value="19">19</button>
                                           <button id="box3" type="button" name="qua" value="20">20</button>
                                           <button id="box3" type="button" name="qua" value="21">21</button>
                                           <button id="box3" type="button" name="qua" value="22">22</button>
                                           </td>
                                           <button id="buttonx" type="button" onclick="myFunction()" style="left: 1006px;bottom: -141.183px;font-weight: 700;">X</button>
                                         </tr>
                                         <tr>
                                          <td>
                                          &nbsp;
                                         ...
                                         <tr>
                                           ...
                                           <td id="box1">
                                           <button id="box3" type="button" name="qui" value="7">7</button>
                                           <button id="box3" type="button" name="qui" value="8">8</button>
                                           <button id="box3" type="button" name="qui" value="9">9</button>
                                           <button id="box3" type="button" name="qui" value="10">10</button>
                                           <button id="box3" type="button" name="qui" value="11">11</button>
                                           <button id="box3" type="button" name="qui" value="12">12</button>
                                           <button id="box3" type="button" name="qui" value="13">13</button>
                                           <button id="box3" type="button" name="qui" value="14">14</button>
                                           <button id="box3" type="button" name="qui" value="15">15</button>
                                           <button id="box3" type="button" name="qui" value="16">16</button>
                                           <button id="box3" type="button" name="qui" value="17">17</button>
                                           <button id="box3" type="button" name="qui" value="18">18</button>
                                           <button id="box3" type="button" name="qui" value="19">19</button>
                                           <button id="box3" type="button" name="qui" value="20">20</button>
                                           <button id="box3" type="button" name="qui" value="21">21</button>
                                           <button id="box3" type="button" name="qui" value="22">22</button>
                                           </td>
                                           <button id="buttonx" type="button" onclick="myFunction()" style="left: 961px;bottom: -197px;font-weight: 700;">X</button>
                                         </tr>
                                         <tr>
                                          <td>
                                          &nbsp;
                                         ...
                                         <tr>
                                           ...
                                           <td id="box1">
                                           <button id="box3" type="button" name="sex" value="7">7</button>
                                           <button id="box3" type="button" name="sex" value="8">8</button>
                                           <button id="box3" type="button" name="sex" value="9">9</button>
                                           <button id="box3" type="button" name="sex" value="10">10</button>
                                           <button id="box3" type="button" name="sex" value="11">11</button>
                                           <button id="box3" type="button" name="sex" value="12">12</button>
                                           <button id="box3" type="button" name="sex" value="13">13</button>
                                           <button id="box3" type="button" name="sex" value="14">14</button>
                                           <button id="box3" type="button" name="sex" value="15">15</button>
                                           <button id="box3" type="button" name="sex" value="16">16</button>
                                           <button id="box3" type="button" name="sex" value="17">17</button>
                                           <button id="box3" type="button" name="sex" value="18">18</button>
                                           <button id="box3" type="button" name="sex" value="19">19</button>
                                           <button id="box3" type="button" name="sex" value="20">20</button>
                                           <button id="box3" type="button" name="sex" value="21">21</button>
                                           <button id="box3" type="button" name="sex" value="22">22</button>
                                           </td>
                                           <button id="buttonx" type="button" onclick="myFunction()" style="left: 916px;bottom: -253px;font-weight: 700;">X</button>
                                         </tr>
                                       </table>
                                       </div>
                                </div>
                                ...
                                <div>
                                    <div class="tm-img-gallery-info-container">
                                        ...
                                        <div style="margin-top: 0px;">
                                            <div class="row" style="margin-right: -144.937rem;">
                                          <div class="column" style="margin-left: -233px;margin-bottom: -36px;">
                                          ...
                                          <div class="column" style="margin-left: 73px;">
                                   ...
                                   <div class="v5"></div>
                                   <div class="v6"></div>
                                   <div><img src="img/rr.png" style="margin-top: -997px;margin-right: 6px;padding-right: 0px;position: relative;right: -1161px;"></div>
                                   <div><img src="img/rr2.png" style="margin-top: -1050px;margin-right: 6px;padding-right: 0px;position: relative;right: -874px;"></div>
                                   <div><hr style="position: relative;top: -609px; margin-right: -760px;margin-left: 730px;margin-top: -0.5rem;bottom: 588px;margin-bottom: -8.2em;"></div>
                                   <div><hr style="position: relative;top: -440px;margin-top: 5.5rem;margin-right: -760px;margin-left: 730px;margin-bottom: 0.5em;"></div>
                                   <div><hr style="position: relative;top: -236px;margin-top: -12.0rem;margin-right: -760px;margin-left: 730px;"></div>
                                   <div class="ggwp2"><img src="img/nobrain.png" style="margin-bottom: -130px;"></div>
                                   <div class="ggwp3"><img src="img/nobraintwo.png" style="margin-bottom: -140px;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
