                    ...
                    <div class="cd-full-width">
                        <div class="container-fluid js-tm-page-content" data-page-no="1" data-page-type="gallery">
                            <div class="tm-img-gallery-container">
                                ...
                                <!-- Formulário PHP -->                                    
                                    <form action="../apigrade/get.php" method="post">
                                       <div style="margin-left: -174px;">
                                          <p><h1 style="margin-bottom: -3.5rem; font-size:30px; font-weight: 700;">Cursos</h1></p>
<!-- ALTERADO nome -->                                            <input id="box" type="text" name="curso" placeholder="&nbsp;&nbsp;Nome do curso" id="nome" />
                                       ...
                                       <table id="myTable" style="width:100%; color:#344253;">
                                         <tr>
                                           ...
                                           <td id="box1">
<!-- ALTERADO -->                         <button id="box3" name="seg7" value="7" type="submit">7</button>
                                           <button id="box3" name="seg8" value="8" type="submit">8</button>
                                           <button id="box3" type="button">9</button>
                                           <button id="box3" type="button">10</button>
                                           <button id="box3" type="button">11</button>
                                           <button id="box3" type="button">12</button>
                                           <button id="box3" type="button">13</button>
                                           <button id="box3" type="button">14</button>
                                           <button id="box3" type="button">15</button>
                                           <button id="box3" type="button">16</button>
                                           <button id="box3" type="button">17</button>
                                           <button id="box3" type="button">18</button>
                                           <button id="box3" type="button">19</button>
                                           <button id="box3" type="button">20</button>
                                           <button id="box3" type="button">21</button>
                                           <button id="box3" type="button">22</button>
                                           </td>
                                         ...
                                         <tr>
                                           ...
                                           <td id="box1">
                                           <button id="box3" type="button">&nbsp;7</button>
                                           <button id="box3" type="button">8</button>
                                           <button id="box3" type="button">9</button>
                                           <button id="box3" type="button">10</button>
                                           <button id="box3" type="button">11</button>
                                           <button id="box3" type="button">12</button>
                                ...
                                <div style="margin-left: 562px;margin-top: 48px;">
                                       ...
                                       <!-- ALTERADO -->                                        <select id="box2" name="lunch">
...
<!-- ALTERADO -->                                        <select id="box2" name="dinner">
                                          <option value="30m">&nbsp;&nbsp;30 minutos</option>
                                          <option value="1h">&nbsp;&nbsp;1 hora</option>
                                          <option value="1h30m">&nbsp;&nbsp;1 h e 30 minutos</option>
                                          <option value="2h">&nbsp;&nbsp;2 horas</option>
                                       ...
                                       <div style="font-size:20px">
                                         <input type="range" id="a" name="a" value="0" min="1" max="15" oninput="x.value=parseInt(a.value)">
                                        Limite de até
