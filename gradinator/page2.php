                                ...
                                <!-- Formulário PHP -->                                    
                                    <form action="destino.php" method="post">
                                       ...
                                       <p><h1 style="margin-bottom: -3.5rem; font-size:30px; font-weight: 700;">Cursos</h1></p>
                                          <input id="box" type="text" placeholder="&nbsp;&nbsp;Nome do curso" id="nome" />
                                          <button id="buttonok" style="font-weight: 700;">ok</button>
                                       </div>
                                       ...
                                       <table id="myTable" style="width:100%; color:#344253;">
                                         <tr>
                                           ...
                                           <td id="box1">
                                           <input id="box3" type="checkbox" name="seg" value="7">7
                                           <input id="box3" type="checkbox" name="seg" value="8">8
                                           <input id="box3" type="checkbox" name="seg" value="9">9
                                           <input id="box3" type="checkbox" name="seg" value="10">10
                                           <input id="box3" type="checkbox" name="seg" value="11">11
                                           <input id="box3" type="checkbox" name="seg" value="12">12
                                           <input id="box3" type="checkbox" name="seg" value="13">13
                                           <input id="box3" type="checkbox" name="seg" value="14">14
                                           <input id="box3" type="checkbox" name="seg" value="15">15
                                           <input id="box3" type="checkbox" name="seg" value="16">16
                                           <input id="box3" type="checkbox" name="seg" value="17">17
                                           <input id="box3" type="checkbox" name="seg" value="18">18
                                           <input id="box3" type="checkbox" name="seg" value="19">19
                                           <input id="box3" type="checkbox" name="seg" value="20">20
                                           <input id="box3" type="checkbox" name="seg" value="21">21
                                           <input id="box3" type="checkbox" name="seg" value="22">22
                                           </td>
                                         ...
                                         <tr>
                                           ...
                                           <td id="box1">
                                           <input id="box3" type="checkbox" name="ter" value="7">7
                                           <input id="box3" type="checkbox" name="ter" value="8">8
                                           <input id="box3" type="checkbox" name="ter" value="9">9
                                           <input id="box3" type="checkbox" name="ter" value="10">10
                                           <input id="box3" type="checkbox" name="ter" value="11">11
                                           <input id="box3" type="checkbox" name="ter" value="12">12
                                           <input id="box3" type="checkbox" name="ter" value="13">13
                                           <input id="box3" type="checkbox" name="ter" value="14">14
                                           <input id="box3" type="checkbox" name="ter" value="15">15
                                           <input id="box3" type="checkbox" name="ter" value="16">16
                                           <input id="box3" type="checkbox" name="ter" value="17">17
                                           <input id="box3" type="checkbox" name="ter" value="18">18
                                           <input id="box3" type="checkbox" name="ter" value="19">19
                                           <input id="box3" type="checkbox" name="ter" value="20">20
                                           <input id="box3" type="checkbox" name="ter" value="21">21
                                           <input id="box3" type="checkbox" name="ter" value="22">22
                                           </td>
                                         ...
                                         <tr>
                                           ...
                                           <td id="box1">
                                           <input id="box3" type="checkbox" name="qua" value="7">7
                                           <input id="box3" type="checkbox" name="qua" value="8">8
                                           <input id="box3" type="checkbox" name="qua" value="9">9
                                           <input id="box3" type="checkbox" name="qua" value="10">10
                                           <input id="box3" type="checkbox" name="qua" value="11">11
                                           <input id="box3" type="checkbox" name="qua" value="12">12
                                           <input id="box3" type="checkbox" name="qua" value="13">13
                                           <input id="box3" type="checkbox" name="qua" value="14">14
                                           <input id="box3" type="checkbox" name="qua" value="15">15
                                           <input id="box3" type="checkbox" name="qua" value="16">16
                                           <input id="box3" type="checkbox" name="qua" value="17">17
                                           <input id="box3" type="checkbox" name="qua" value="18">18
                                           <input id="box3" type="checkbox" name="qua" value="19">19
                                           <input id="box3" type="checkbox" name="qua" value="20">20
                                           <input id="box3" type="checkbox" name="qua" value="21">21
                                           <input id="box3" type="checkbox" name="qua" value="22">22
                                           </td>
                                         ...
                                         <tr>
                                           ...
                                           <td id="box1">
                                           <input id="box3" type="checkbox" name="qui" value="7">7
                                           <input id="box3" type="checkbox" name="qui" value="8">8
                                           <input id="box3" type="checkbox" name="qui" value="9">9
                                           <input id="box3" type="checkbox" name="qui" value="10">10
                                           <input id="box3" type="checkbox" name="qui" value="11">11
                                           <input id="box3" type="checkbox" name="qui" value="12">12
                                           <input id="box3" type="checkbox" name="qui" value="13">13
                                           <input id="box3" type="checkbox" name="qui" value="14">14
                                           <input id="box3" type="checkbox" name="qui" value="15">15
                                           <input id="box3" type="checkbox" name="qui" value="16">16
                                           <input id="box3" type="checkbox" name="qui" value="17">17
                                           <input id="box3" type="checkbox" name="qui" value="18">18
                                           <input id="box3" type="checkbox" name="qui" value="19">19
                                           <input id="box3" type="checkbox" name="qui" value="20">20
                                           <input id="box3" type="checkbox" name="qui" value="21">21
                                           <input id="box3" type="checkbox" name="qui" value="22">22
                                           </td>
                                         ...
                                         <tr>
                                           ...
                                           <td id="box1">
                                           <input id="box3" type="checkbox" name="sex" value="7">7
                                           <input id="box3" type="checkbox" name="sex" value="8">8
                                           <input id="box3" type="checkbox" name="sex" value="9">9
                                           <input id="box3" type="checkbox" name="sex" value="10">10
                                           <input id="box3" type="checkbox" name="sex" value="11">11
                                           <input id="box3" type="checkbox" name="sex" value="12">12
                                           <input id="box3" type="checkbox" name="sex" value="13">13
                                           <input id="box3" type="checkbox" name="sex" value="14">14
                                           <input id="box3" type="checkbox" name="sex" value="15">15
                                           <input id="box3" type="checkbox" name="sex" value="16">16
                                           <input id="box3" type="checkbox" name="sex" value="17">17
                                           <input id="box3" type="checkbox" name="sex" value="18">18
                                           <input id="box3" type="checkbox" name="sex" value="19">19
                                           <input id="box3" type="checkbox" name="sex" value="20">20
                                           <input id="box3" type="checkbox" name="sex" value="21">21
                                           <input id="box3" type="checkbox" name="sex" value="22">22
                                           </td>
